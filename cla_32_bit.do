...
add wave -noupdate -radix hexadecimal /cla_32_bit_testbench/P
add wave -noupdate -radix hexadecimal /cla_32_bit_testbench/G
add wave -noupdate -radix hexadecimal /cla_32_bit_testbench/Cout
add wave -noupdate -color Orange /cla_32_bit_testbench/S_check
add wave -noupdate -color Orange /cla_32_bit_testbench/P_check
add wave -noupdate -color Orange /cla_32_bit_testbench/G_check
